...
function createCombo(elementType){
    ...
    newEle.onclick=function(){
      ...
      displayMenu('selectOperation');
      closeMenu('selectItem');
    };
    document.getElementById("selectItem").onclick=function(){
       closeMenu('selectItem');
       
    };
      document.getElementById("selectOperation").onclick=function(){
       closeMenu('selectOperation');
